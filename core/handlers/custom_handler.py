...
def init(update,context):
    if str(update.effective_message.text).lower().startswith("nebula") or str(update.effective_message.text).lower().startswith("!") or str(update.effective_message.text).lower().startswith("/"):
